...
$(document).ready(function(){
    ...
    $(window).resize(function(){
        ...
        $('#b1').animate({top:240, left: vw-450},500);
        $('#b2').animate({top:240, left: vw-350},500);
        $('#b3').animate({top:240, left: vw-250},500);
        $('#b4').animate({top:240, left: vw-150},500);
        $('#b5').animate({top:240, left: vw-50},500);
        $('#b6').animate({top:240, left: vw+50},500);
